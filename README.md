...
Screenshare in System Preferences but Sidecar not there.  This is the orignal Asus Azurewave that is still supported buty obviously not all features are supported.
